...
class TestNiceNumberFormat_gl(unittest.TestCase):
    def test_convert_float_to_nice_number_gl(self):
        for number, number_str in NUMBERS_FIXTURE_GL.items():
            self.assertEqual(nice_number(number, lang="gl-es"), number_str,
                             'should format {} as {} and not {}'.format(
                                 number, number_str, nice_number(
                                     number, lang="gl-es")))

    def test_specify_denominator_gl(self):
...
class TestPronounceNumber(unittest.TestCase):
    def test_convert_int(self):
        self.assertEqual(pronounce_number(0, lang="gl"), "cero")
        self.assertEqual(pronounce_number(1, lang="gl"), "un")
        self.assertEqual(pronounce_number(10, lang="gl"), "dez")
        self.assertEqual(pronounce_number(15, lang="gl"), "quince")
        self.assertEqual(pronounce_number(21, lang="gl"), "vinte e un")
        self.assertEqual(pronounce_number(27, lang="gl"), "vinte e sete")
        self.assertEqual(pronounce_number(30, lang="gl"), "trinta")
        self.assertEqual(pronounce_number(19, lang="gl"), "dezanove")
        self.assertEqual(pronounce_number(88, lang="gl"), "oitenta e oito")
        self.assertEqual(pronounce_number(46, lang="gl"), "corenta e seis")
        self.assertEqual(pronounce_number(99, lang="gl"), "noventa e nove")

    def test_convert_negative_int(self):
        self.assertEqual(pronounce_number(-1, lang="gl"), "menos un")
        self.assertEqual(pronounce_number(-10, lang="gl"), "menos dez")
        self.assertEqual(pronounce_number(-15, lang="gl"), "menos quince")
        self.assertEqual(pronounce_number(-21, lang="gl"), "menos vinte e un")
        self.assertEqual(pronounce_number(-27, lang="gl"), "menos vinte e sete")
        self.assertEqual(pronounce_number(-30, lang="gl"), "menos trinta")
        self.assertEqual(pronounce_number(-35, lang="gl"),
                         "menos trinta e cinco")
        self.assertEqual(pronounce_number(-83, lang="gl"),
                         "menos oitenta e tres")
        self.assertEqual(pronounce_number(-19, lang="gl"), "menos dezanove")
        self.assertEqual(pronounce_number(-88, lang="gl"),
                         "menos oitenta e oito")
        self.assertEqual(pronounce_number(-46, lang="gl"),
                         "menos corenta e seis")
        self.assertEqual(pronounce_number(-99, lang="gl"),
                         "menos noventa e nove")

    def test_convert_decimals(self):
        self.assertEqual(pronounce_number(
            0.05, lang="gl"), "cero coma cero cinco")
        self.assertEqual(pronounce_number(
            -0.05, lang="gl"), "menos cero coma cero cinco")
        self.assertEqual(pronounce_number(1.234, lang="gl"),
                         "uno coma dous tres catro")
        self.assertEqual(pronounce_number(21.234, lang="gl"),
                         "vinte e un coma dous tres")
        self.assertEqual(pronounce_number(21.234, lang="gl", places=1),
                         "vinte e un coma dous")
        self.assertEqual(pronounce_number(21.234, lang="gl", places=0),
                         "vinte e un")
        self.assertEqual(pronounce_number(21.234, lang="gl", places=3),
                         "vinte e un coma dous tres catro")
        self.assertEqual(pronounce_number(21.234, lang="gl", places=4),
                         "vinte e un coma dous tres catro")
        self.assertEqual(pronounce_number(21.234, lang="gl", places=5),
                         "vinte e un coma dous tres catro")
        self.assertEqual(pronounce_number(-21.234, lang="gl"),
...
class TestNiceDateFormat(unittest.TestCase):
    def test_convert_times(self):
        ...
        self.assertEqual(nice_time(dt, lang="gl-es"),
                         nice_time(dt, "gl", True, False, False))

        self.assertEqual(nice_time(dt, lang="gl-es"),
                         "a unha e vinte e dous")
        self.assertEqual(nice_time(dt, lang="gl", use_ampm=True),
                         "a unha e vinte e dous da tarde")
        self.assertEqual(nice_time(dt, lang="gl", speech=False), "1:22")
        self.assertEqual(nice_time(dt, lang="gl", speech=False,
                                   use_ampm=True), "1:22 PM")
        self.assertEqual(nice_time(dt, lang="gl", speech=False,
                                   use_24hour=True), "13:22")
        self.assertEqual(nice_time(dt, lang="gl", speech=False,
                                   use_24hour=True, use_ampm=True), "13:22")
        self.assertEqual(nice_time(dt, lang="gl", use_24hour=True,
        ...
        self.assertEqual(nice_time(dt, lang="gl"),
                         "a unha en punto")
        self.assertEqual(nice_time(dt, lang="gl", use_ampm=True),
                         "a unha da tarde")
        self.assertEqual(nice_time(dt, lang="gl", speech=False),
        ...
        self.assertEqual(nice_time(dt, lang="gl-es", speech=False,
                         ...
                         "12:15")
        self.assertEqual(nice_time(dt, lang="gl-es-es", use_24hour=True,
                                   use_ampm=True),
                         "as doce quince")
